        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card" id="invoice">
                    ...
                    <div class="card-footer"> <span class="text-muted">Thank you to choose our service we always welcome you. For any update and help contact our support team <a href="./feedback.php">Safar.com</a></span> </div>
                </div>
            </div>
        </div>
    </div>
